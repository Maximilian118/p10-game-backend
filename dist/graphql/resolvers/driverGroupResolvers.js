...
const driverGroupResolvers = {
    ...
    getDriverGroups: (_a, req_1) => __awaiter(void 0, [_a, req_1], void 0, function* ({}, req) {
        if (!req.isAuth) {
            (0, resolverErrors_1.throwError)("getDriverGroups", req.isAuth, "Not Authenticated!", 401);
        }
        try {
            const driverGroups = yield driverGroup_1.default.find().exec();
            return {
                array: driverGroups,
                tokens: req.tokens,
            };
...
//# sourceMappingURL=driverGroupResolvers.js.map